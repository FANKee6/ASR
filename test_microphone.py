...
# Usage:
# - To run the script, specify the language model using the -m flag. Example: `python test_microphone.py -m en-us`
...
# Example command to run: `python test_microphone.py -m en-us`
